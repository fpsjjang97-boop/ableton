    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-suno-card border border-suno-border rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-suno-muted text-sm">AI 음악 커뮤니티에 오신 것을 환영합니다</p>
            </div>
            ...
            $loginErrorMsg = isset($loginErrors[$loginError]) ? $loginErrors[$loginError] : '';
            ?>
            ...
            <!-- Login Form -->
            <form action="login_ok.php" method="POST" class="space-y-4">
                <div>
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded border-suno-border bg-suno-surface text-suno-accent focus:ring-suno-accent/50">
                        <span class="text-xs text-suno-muted">로그인 상태 유지</span>
                    </label>
                    <a href="forgot_password.php" class="text-xs text-suno-accent hover:text-suno-accent2 transition-colors">비밀번호 찾기</a>
                </div>
            ...
            <div class="text-center mt-8 pt-6 border-t border-suno-border">
                <p class="text-sm text-suno-muted">
                    아직 계정이 없으신가요?
                    <a href="register.php" class="text-suno-accent hover:text-suno-accent2 font-medium transition-colors">회원가입</a>
                </p>
            </div>
        </div>
    </div>
